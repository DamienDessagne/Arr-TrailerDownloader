...
```yaml
volumes:
  - "C:/Users/you/AppData/Roaming/Mozilla/Firefox/Profiles/xxxxxxxx.default-release:/cookies/firefox-profile:ro"
```
3. In `config.ini`, append the in-container path after a colon:
```ini
